          ...
          for (d = {}; c < e.length; ) {
            ...
            f =
              ('object' == k && null != q) || 'function' == k
                ? 'o' +
                  ((Object.prototype.hasOwnProperty.call(q, n) &&
                    q[n]) ||
                    (q[n] = ++da))
                : (typeof q).charAt(0) + q;
  ...
  window.gapi.load('', {
    ...
    _c: {
      ...
      jsl: {
        ...
        h: 'm;/_/scs/abc-static/_/js/k=gapi.lb.fr.9D3QXXD-fjY.O/d=1/rs=AHpOoo-7XyZZF5ljY_ja5zCjh4s67VXLXA/m=__features__',
